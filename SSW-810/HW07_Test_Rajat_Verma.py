...
class HW07_Test_Rajat_Verma(unittest.TestCase):
    ...
    def test_anagrams_lst(self) -> None:
        ...
        self.assertEquals(test.anagrams_lst("hands", "sandh"), True)
        self.assertEquals(test.anagrams_lst("Name", "Fame"), False)
        self.assertEquals(test.anagrams_lst("", ""), True)
        self.assertEquals(test.anagrams_lst("tom cat", "tomc at"), True)
    ...
    def test_covers_alphabet(self) -> None:
        ...
        """
        test: Homework07 = Homework07()
        self.assertEquals(test.covers_alphabet("qwertyuiopasdfghjklzxcvbnm"), True)
        self.assertEquals(test.covers_alphabet("We promptly judged antique ivory buckles for the next prize"), True)
