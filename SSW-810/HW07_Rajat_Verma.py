...
class Homework07:
    ...
    def anagrams_lst(self, str1: str, str2: str) -> bool:
        ...
        if not isinstance(str1, str) or not isinstance(str2, str):  # If the input is not of type 'List', raise ValueError
    ...
    def anagrams_cntr(self, str1: str, str2: str) -> bool:
        ...
        if not isinstance(str1, str) or not isinstance(str2, str):  # If the input is not of type 'Str', raise ValueError
            raise ValueError("Input l must be of type String")
    ...
    def covers_alphabet(self, sentence: str) -> bool:
        ...
        """
        if not isinstance(sentence, str):  # If the input is not of type 'Str', raise ValueError
